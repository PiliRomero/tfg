...
texto2="""
A continuación se va a aplicar la técniaca de k-Medias para lograr identificar formas de onda completas. Para ello en primer lugar se realiza el **preprocesamiento** de las señales aplicando la transformada de wavelet. Se fija un nivel de resolución M común para todas las señales. Cada instancia estará formada por los coeficientes de aproximación para este nivel de resolución. De este modo se representará cada una de las señales originales por un número de coeficientes que dependerá de la profundidad M. A mayor profundidad la reducción de la dimensionalidad va a ser más significativa pero el ajuste va a ser peor.
"""
st.write(texto2)
...
conjunto de ejemplos de entrenamiento. En efecto, a continuación se dibuja el gráfico de dispersion para la primera y segunda
commponente principal de los coeficientes de aproximación de la transformada wavelet y se colorean en función del clúster al que pertenecen.
Se puede commprobar como existen instancias que en los modelos de agrupamiento jerárquico y k-medias forman parte de clústeres distintos. Para simplificar
en el mmétodo de agrupamiento jerárquico se ha utilizado la omo función linkage la función ward
"""
st.write(texto8)
