...
with col2:
    ...
    st.pyplot(dibujarWavelet(optionW))

st.subheader("Coeficientes de aproximación y detalle", divider="red")
st.pyplot(digujarCoeficientes(serie,optionW))
...
with col21:
    ...
    **Número de coeficientes de aproximación** :
    """
    st.write(texto9+str(dibujarCAeInv(serie,optionW,mSelec)[0]))

with col22:
    st.pyplot(dibujarSerie(serie))

st.pyplot(dibujarCAeInv(serie,optionW,mSelec)[1])
